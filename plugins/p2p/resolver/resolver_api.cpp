...
void plugin::resolver_api::publish_api(forge::api::core::binding_plan plan,
...
plugin::resolver_api::resolve(forge::net::p2p::peer_id peer, forge::api::core::api_ref api, resolve_options options) {
