...
class plugin::resolver_api final : public api {
 public:
   ...
   void publish_api(forge::api::binding_plan plan, forge::net::p2p::protocol_id protocol,
   ...
   boost::asio::awaitable<resolution> resolve(forge::net::p2p::peer_id peer, forge::api::api_ref api,
                                              resolve_options options) override;

 private:
   boost::asio::awaitable<resolved_connection>
   open_resolved_connection(forge::net::p2p::peer_id peer, forge::api::api_ref api,
