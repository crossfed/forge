...
inline bool _wasm_f32_eq( float a, float b ) {  return ::f32_eq( to_softfloat32(a), to_softfloat32(b) ); }
inline bool _wasm_f32_ne( float a, float b ) { return !::f32_eq( to_softfloat32(a), to_softfloat32(b) ); }
inline bool _wasm_f32_lt( float a, float b ) { return ::f32_lt( to_softfloat32(a), to_softfloat32(b) ); }
inline bool _wasm_f32_le( float a, float b ) { return ::f32_le( to_softfloat32(a), to_softfloat32(b) ); }
...
inline bool _wasm_f64_eq( double a, double b ) { return ::f64_eq( to_softfloat64(a), to_softfloat64(b) ); }
inline bool _wasm_f64_ne( double a, double b ) { return !::f64_eq( to_softfloat64(a), to_softfloat64(b) ); }
inline bool _wasm_f64_lt( double a, double b ) { return ::f64_lt( to_softfloat64(a), to_softfloat64(b) ); }
inline bool _wasm_f64_le( double a, double b ) { return ::f64_le( to_softfloat64(a), to_softfloat64(b) ); }
...
inline int32_t _wasm_f32_trunc_i32s( float af ) {
   float32_t a = to_softfloat32(af);
   detail::check<exceptions::interpreter>((!(_wasm_f32_ge(af, 2147483648.0f) || _wasm_f32_lt(af, -2147483648.0f))), "Error, f32.convert_s/i32 overflow");
...
inline int32_t _wasm_f64_trunc_i32s( double af ) {
   float64_t a = to_softfloat64(af);
   detail::check<exceptions::interpreter>((!(_wasm_f64_ge(af, 2147483648.0) || _wasm_f64_lt(af, -2147483648.0))), "Error, f64.convert_s/i32 overflow");
...
inline uint32_t _wasm_f32_trunc_i32u( float af ) {
   float32_t a = to_softfloat32(af);
   detail::check<exceptions::interpreter>((!(_wasm_f32_ge(af, 4294967296.0f) || _wasm_f32_le(af, -1.0f))), "Error, f32.convert_u/i32 overflow");
...
inline uint32_t _wasm_f64_trunc_i32u( double af ) {
   float64_t a = to_softfloat64(af);
   detail::check<exceptions::interpreter>((!(_wasm_f64_ge(af, 4294967296.0) || _wasm_f64_le(af, -1.0))), "Error, f64.convert_u/i32 overflow");
...
inline int64_t _wasm_f32_trunc_i64s( float af ) {
   float32_t a = to_softfloat32(af);
      detail::check<exceptions::interpreter>((!(_wasm_f32_ge(af, 9223372036854775808.0f) || _wasm_f32_lt(af, -9223372036854775808.0f))), "Error, f32.convert_s/i64 overflow");
...
inline int64_t _wasm_f64_trunc_i64s( double af ) {
   float64_t a = to_softfloat64(af);
   detail::check<exceptions::interpreter>((!(_wasm_f64_ge(af, 9223372036854775808.0) || _wasm_f64_lt(af, -9223372036854775808.0))), "Error, f64.convert_s/i64 overflow");
...
inline uint64_t _wasm_f32_trunc_i64u( float af ) {
   float32_t a = to_softfloat32(af);
   detail::check<exceptions::interpreter>((!(_wasm_f32_ge(af, 18446744073709551616.0f) || _wasm_f32_le(af, -1.0f))), "Error, f32.convert_u/i64 overflow");
...
inline uint64_t _wasm_f64_trunc_i64u( double af ) {
   float64_t a = to_softfloat64(af);
   detail::check<exceptions::interpreter>((!(_wasm_f64_ge(af, 18446744073709551616.0) || _wasm_f64_le(af, -1.0))), "Error, f64.convert_u/i64 overflow");
...
namespace forge::vm::wasm {
   ...
   struct interpret_visitor : base_visitor {
      ...
      [[gnu::always_inline]] inline void operator()(const i32_div_s_t& op) {
         ...
         detail::check<exceptions::interpreter>((!(lhs == std::numeric_limits<int32_t>::min() && rhs == -1)), "i32.div_s traps when I32_MAX/-1");
         lhs /= rhs;
      }
      ...
      [[gnu::always_inline]] inline void operator()(const i64_div_s_t& op) {
         ...
         detail::check<exceptions::interpreter>((!(lhs == std::numeric_limits<int64_t>::min() && rhs == -1)), "i64.div_s traps when I64_MAX/-1");
         lhs /= rhs;
      }
      ...
      [[gnu::always_inline]] inline void operator()(const i32_trunc_s_f32_t& op) {
         ...
         if constexpr (use_softfloat) {
            ...
            detail::check<exceptions::interpreter>((!((af >= 2147483648.0f) || (af < -2147483648.0f))), "Error, f32.trunc_s/i32 overflow");
      ...
      [[gnu::always_inline]] inline void operator()(const i32_trunc_u_f32_t& op) {
         ...
         if constexpr (use_softfloat) {
            ...
            float af = oper.to_f32();
            detail::check<exceptions::interpreter>((!((af >= 4294967296.0f) || (af <= -1.0f))), "Error, f32.trunc_u/i32 overflow");
      ...
      [[gnu::always_inline]] inline void operator()(const i32_trunc_s_f64_t& op) {
         ...
         if constexpr (use_softfloat) {
            ...
            detail::check<exceptions::interpreter>((!((af >= 2147483648.0) || (af < -2147483648.0))), "Error, f64.trunc_s/i32 overflow");
      ...
      [[gnu::always_inline]] inline void operator()(const i32_trunc_u_f64_t& op) {
         ...
         if constexpr (use_softfloat) {
            ...
            double af = oper.to_f64();
            detail::check<exceptions::interpreter>((!((af >= 4294967296.0) || (af <= -1.0))), "Error, f64.trunc_u/i32 overflow");
      ...
      [[gnu::always_inline]] inline void operator()(const i64_trunc_s_f32_t& op) {
         ...
         if constexpr (use_softfloat) {
            ...
            float af = oper.to_f32();
            detail::check<exceptions::interpreter>((!((af >= 9223372036854775808.0f) || (af < -9223372036854775808.0f))), "Error, f32.trunc_s/i64 overflow");
      ...
      [[gnu::always_inline]] inline void operator()(const i64_trunc_u_f32_t& op) {
         ...
         if constexpr (use_softfloat) {
            ...
            float af = oper.to_f32();
            detail::check<exceptions::interpreter>((!((af >= 18446744073709551616.0f) || (af <= -1.0f))), "Error, f32.trunc_u/i64 overflow");
      ...
      [[gnu::always_inline]] inline void operator()(const i64_trunc_s_f64_t& op) {
         ...
         if constexpr (use_softfloat) {
            ...
            double af = oper.to_f64();
            detail::check<exceptions::interpreter>((!((af >= 9223372036854775808.0) || (af < -9223372036854775808.0))), "Error, f64.trunc_s/i64 overflow");
      ...
      [[gnu::always_inline]] inline void operator()(const i64_trunc_u_f64_t& op) {
         ...
         if constexpr (use_softfloat) {
            ...
            double af = oper.to_f64();
            detail::check<exceptions::interpreter>((!((af >= 18446744073709551616.0) || (af <= -1.0))), "Error, f64.trunc_u/i64 overflow");
...
#define DBG2_VISIT(name, code)                                                                                         \
   void operator()(const FORGE_VM_WASM_OPCODE_T(name)& op) { std::cout << "Found " << #name << "\n"; }
...
namespace forge::vm::wasm {
   ...
   extern thread_local std::atomic<sigjmp_buf*> signal_dest;

   __attribute__((visibility("default")))
   extern thread_local std::span<std::byte> code_memory_range;

   __attribute__((visibility("default")))
   extern thread_local std::span<std::byte> memory_range;

   __attribute__((visibility("default")))
   extern thread_local std::atomic<bool> timed_run_has_timed_out;

   // Fixes a duplicate symbol build issue when building with `-fvisibility=hidden`
   __attribute__((visibility("default")))
   extern thread_local std::exception_ptr saved_exception;
   ...
   auto invoke_with_signal_handler(F&& f, E&& e, growable_allocator& code_allocator, wasm_allocator* mem_allocator) {
      return invoke_with_signal_handler(
         std::forward<F>(f),
         std::forward<E>(e),
         &code_allocator,
         mem_allocator
...
namespace forge::vm::wasm {
   ...
   class execution_context_base {
    ...
    public:
      ...
      void               set_max_pages(std::uint32_t max_pages) { _max_pages = std::min(max_pages, static_cast<std::uint32_t>(::forge::vm::wasm::max_pages)); }
      ...
      inline void reset(Module& mod) {
         ...
         if(mod.memories.size()) {
            detail::check<exceptions::allocation>((mod.memories[0].limits.initial <= _max_pages), "Cannot allocate initial linear memory.");
    ...
    protected:
      ...
      static void type_check_args(const Func_type& ft, Args&&...) {
         ...
         uint32_t i = 0;
         detail::check<exceptions::interpreter>(((... && (to_wasm_type_v<detail::type_converter_t<Host>, Args> == ft.param_types.at(i++)))), "unexpected argument type");
      }
   ...
   class execution_context : public execution_context_base<execution_context<Host>, Host, false> {
    ...
    public:
      ...
      inline operand_stack_elem  get_global(uint32_t index) {
         ...
         detail::check<exceptions::interpreter>((index < _globals.size()), "index for _globals out of range in get_global for interpreter");
         ...
         switch (gl.type.content_type) {
            ...
            default: throw exceptions::interpreter{ "invalid global type" };
         }
      }
      ...
      inline void set_global(uint32_t index, const operand_stack_elem& el) {
         ...
         visit(overloaded{ [&](const i32_const_t& i) {
                                  detail::check<exceptions::interpreter>((gl.type.content_type == types::i32), "expected i32 global type");
                                  _globals[index].value.i32 = i.data.ui;
                               },
                                [&](const i64_const_t& i) {
                                   detail::check<exceptions::interpreter>((gl.type.content_type == types::i64), "expected i64 global type");
                                   _globals[index].value.i64 = i.data.ui;
                                },
                                [&](const f32_const_t& f) {
                                   detail::check<exceptions::interpreter>((gl.type.content_type == types::f32), "expected f32 global type");
                                   _globals[index].value.f32 = f.data.ui;
                                },
                                [&](const f64_const_t& f) {
                                   detail::check<exceptions::interpreter>((gl.type.content_type == types::f64), "expected f64 global type");
      ...
      inline void type_check(const func_type& ft) {
         for (uint32_t i = 0; i < ft.param_types.size(); i++) {
            ...
            visit(overloaded{ [&](const i32_const_t&) {
                                     detail::check<exceptions::interpreter>((ft.param_types[i] == types::i32), "function param type mismatch");
                                  },
                                   [&](const f32_const_t&) {
                                      detail::check<exceptions::interpreter>((ft.param_types[i] == types::f32), "function param type mismatch");
                                   },
                                   [&](const i64_const_t&) {
                                      detail::check<exceptions::interpreter>((ft.param_types[i] == types::i64), "function param type mismatch");
                                   },
                                   [&](const f64_const_t&) {
                                      detail::check<exceptions::interpreter>((ft.param_types[i] == types::f64), "function param type mismatch");
                                   },
      ...
      inline std::optional<operand_stack_elem> execute(host_type* host, Visitor&& visitor, uint32_t func_index, Args&&... args) {
         detail::check<exceptions::interpreter>((func_index < std::numeric_limits<uint32_t>::max()), "cannot execute function, function not found");
         ...
         for (uint32_t i = 0; i < fn.locals.size(); i++) {
            for (uint32_t j = 0; j < fn.locals[i].count; j++)
               switch (fn.locals[i].type) {
                  ...
                  default: throw exceptions::interpreter{ "invalid function param type" };
               }
         }
      }
...
#define CREATE_LABEL(NAME, CODE)                                                                                  \
      ev_label_##NAME : std::forward<Visitor>(visitor)(ev_variant->template get<forge::vm::wasm::FORGE_VM_WASM_OPCODE_T(NAME)>()); \
...
#define CREATE_EMPTY_LABEL(NAME, CODE) ev_label_##NAME :  \
      throw exceptions::interpreter{"empty operand"};

      template <typename Visitor>
      void execute(Visitor&& visitor) {
         static void* dispatch_table[] = {
            FORGE_VM_WASM_CONTROL_FLOW_OPS(CREATE_TABLE_ENTRY)
            FORGE_VM_WASM_BR_TABLE_OP(CREATE_TABLE_ENTRY)
            FORGE_VM_WASM_RETURN_OP(CREATE_TABLE_ENTRY)
            FORGE_VM_WASM_CALL_OPS(CREATE_TABLE_ENTRY)
            FORGE_VM_WASM_CALL_IMM_OPS(CREATE_TABLE_ENTRY)
            FORGE_VM_WASM_PARAMETRIC_OPS(CREATE_TABLE_ENTRY)
            FORGE_VM_WASM_VARIABLE_ACCESS_OPS(CREATE_TABLE_ENTRY)
            FORGE_VM_WASM_MEMORY_OPS(CREATE_TABLE_ENTRY)
            ...
            for (;; cnt++) {
               ...
               if ((storage[cnt] & 0x80) == 0) {
                  if( static_cast<size_t>(cnt + 1)  == bytes_needed<N>() ) {
                     ...
                     detail::check<exceptions::parse>(((mask & storage[cnt]) == 0), "unused bits of unsigned leb128 must be 0");
                  }
                  break;
               }
            }
               ...
               if ((storage[cnt] & 0x80) == 0) {
                  if( static_cast<size_t>(cnt + 1) == bytes_needed<N>() ) {
                    uint32_t offset = N - 7*(bytes_needed<N>()-1);
                     ...
                     detail::check<exceptions::parse>(((mask & storage[cnt]) == expected), "unused bits of signed leb128 must be the same as the sign bit");
                  }
                  break;
               }
            }
...
namespace forge::vm::wasm {
   ...
   struct max_mutable_globals_checker<Options, std::void_t<max_mutable_globals_t<Options>>> {
      ...
      void on_mutable_global(const Options& options, uint8_t type) {
         ...
         _counter += size;
         detail::check<exceptions::parse>((_counter <= options.max_mutable_global_bytes && _counter >= size), "mutable globals exceeded limit");
      }
...
#define MAX_ELEMENTS(name, default_)\
   ...
   struct max_func_local_bytes_checker<Options, std::void_t<decltype(std::declval<Options>().max_func_local_bytes)>> {
      ...
      void on_type(const Options& options, std::uint8_t type) {
         unsigned size = get_size_for_type(type);
         _count += size;
         detail::check<exceptions::parse>((_count <= options.max_func_local_bytes && _count >= size), "local variable limit exceeded");
      }
   ...
   template<typename Options, typename Enable = void>
   struct max_control_depth_checker {
    ...
    public:
      ...
      int validate_utf8_code_point(wasm_code_ptr& code) {
         ...
         if (ch < 0x80) {
           ...
           detail::check<exceptions::parse>(((ch & 0xC0) == 0xC0), "invalid utf8 encoding");
            ...
            detail::check<exceptions::parse>(((0x800 <= code_point && code_point < 0xD800) ||
                          (0xE000 <= code_point && code_point < 0x10000)), "invalid utf8 encoding");
            return 3;
         } else if (ch < 0xF8) {
            unsigned char b2 = *code++;
            detail::check<exceptions::parse>(((b2 & 0xC0) == 0x80), "invalid utf8 encoding");
      ...
      void parse_module(wasm_code_ptr& code_ptr, size_t sz, module& mod, DebugInfo& debug) {
         ...
         for (;;) {
            ...
            switch (id) {
               ...
               default: detail::fail<exceptions::parse>( "error invalid section id");
            }
         }
         detail::check<exceptions::parse>((_mod->code.size() == _mod->functions.size()), "code section must have the same size as the function section");
      ...
      void parse_import_entry(wasm_code_ptr& code, import_entry& entry) {
         ...
         switch ((uint8_t)entry.kind) {
            case external_kind::Function:
               ...
               break;
            default: detail::fail<exceptions::unsupported_import>( "only function imports are supported");
         }
      }
      ...
      void parse_table_type(wasm_code_ptr& code, table_type& tt) {
         ...
         if (tt.limits.flags) {
            ...
            detail::check<exceptions::parse>((tt.limits.initial <= tt.limits.maximum), "table max size less than min size");
         }
         detail::check<exceptions::parse>((tt.limits.initial <= detail::get_max_table_elements(_options)), "table size exceeds limit");
      ...
      void parse_global_variable(wasm_code_ptr& code, global_variable& gv) {
         ...
         detail::check<exceptions::parse>((ct == types::i32 || ct == types::i64 || ct == types::f32 || ct == types::f64), "invalid global content type");
      ...
      void parse_memory_type(wasm_code_ptr& code, memory_type& mt) {
         ...
         detail::check<exceptions::parse>((mt.limits.initial <= detail::get_max_pages(_options)), "initial memory out of range");
         // WASM specification
      ...
      void parse_export_entry(wasm_code_ptr& code, export_entry& entry) {
         ...
         switch(entry.kind) {
            case external_kind::Function: detail::check<exceptions::parse>((entry.index < _mod->get_functions_total()), "function export out of range"); break;
            case external_kind::Table: detail::check<exceptions::parse>((entry.index < _mod->tables.size()), "table export out of range"); break;
            case external_kind::Memory: detail::check<exceptions::parse>((entry.index < _mod->memories.size()), "memory export out of range"); break;
            case external_kind::Global:
               detail::check<exceptions::parse>((entry.index < _mod->globals.size()), "global export out of range");
               detail::check<exceptions::parse>((!detail::get_forbid_export_mutable_globals(_options) || !_mod->globals.at(entry.index).type.mutability), "cannot export mutable globals");
               break;
            default: detail::fail<exceptions::parse>( "Unknown export kind"); break;
         }
      }
      ...
      void parse_func_type(wasm_code_ptr& code, func_type& ft) {
         ...
         for (size_t i = 0; i < param_types.size(); i++) {
            uint8_t pt        = *code++;
            param_types.at(i) = pt;
            detail::check<exceptions::parse>((pt == types::i32 || pt == types::i64 || pt == types::f32 || pt == types::f64), "invalid function param type");
         }
         ...
         if (ft.return_count > 0) {
            uint8_t rt        = *code++;
            ft.return_type = rt;
            detail::check<exceptions::parse>((rt == types::i32 || rt == types::i64 || rt == types::f32 || rt == types::f64), "invalid function return type");
         }
      }
      ...
      void parse_elem_segment(wasm_code_ptr& code, elem_segment& es) {
         ...
         uint32_t           size  = parse_varuint32(code);
         detail::check<exceptions::parse>((size <= detail::get_max_element_segment_elements(_options)), "elem segment too large");
      ...
      void parse_init_expr(wasm_code_ptr& code, init_expr& ie, uint8_t type) {
         ...
         switch (ie.opcode) {
            ...
            case opcodes::f64_const:
               ...
               break;
            default:
               detail::fail<exceptions::parse>( "initializer expression can only acception i32.const, i64.const, f32.const and f64.const");
         }
      ...
      void parse_function_body(wasm_code_ptr& code, function_body& fb, std::size_t idx) {
         ...
         detail::check<exceptions::parse>((local_cnt <= detail::get_max_local_sets(_options)), "Number of local sets exceeds limit");
         ...
         for (size_t i = 0; i < local_cnt; i++) {
            ...
            detail::check<exceptions::parse>((type == types::i32 || type == types::i64 || type == types::f32 || type == types::f64), "invalid local type");
         ...
         code += fb.size-1;
         detail::check<exceptions::parse>((detail::get_allow_code_after_function_end(_options) || *code == 0x0B), "failed parsing function body, expected 'end'");
         ++code;
      }
      ...
      struct operand_stack_type_tracker {
         ...
         void push(uint8_t type) {
            ...
            detail::check<exceptions::parse>((operand_depth < std::numeric_limits<uint32_t>::max()), "integer overflow in operand depth");
            ++operand_depth;
      ...
      void parse_function_body_code(wasm_code_ptr& code, size_t bounds, const detail::max_func_local_bytes_stack_checker<Options>& local_bytes_checker,
         ...
         auto exit_scope = [&]() {
            ...
            detail::check<exceptions::parse>((!pc_stack.back().is_if || pc_stack.back().expected_result == types::pseudo), "wrong type");
         ...
         auto check_in_bounds = [&]{
            detail::check<exceptions::parse>((!detail::get_allow_code_after_function_end(_options) || !pc_stack.empty()), "code after function end");
         };

         while (code.offset() < bounds) {
            detail::check<exceptions::parse>((pc_stack.size() <= detail::get_max_nested_structures(_options)), "nested structures validation failure");
            ...
            switch (*code++) {
               ...
               case opcodes::end: {
                  check_in_bounds();
                  exit_scope();
                  detail::check<exceptions::parse>((detail::get_allow_code_after_function_end(_options) ||
                                !pc_stack.empty() || code.offset() == bounds), "function too short");
               ...
               case opcodes::block: {
                  ...
                  detail::check<exceptions::parse>((expected_result == types::i32 || expected_result == types::i64 ||
                                ...
                                expected_result == types::pseudo), "Invalid type code in block");
               ...
               case opcodes::loop: {
                  ...
                  detail::check<exceptions::parse>((expected_result == types::i32 || expected_result == types::i64 ||
                                expected_result == types::f32 || expected_result == types::f64 ||
                                expected_result == types::pseudo), "Invalid type code in loop");
               ...
               case opcodes::if_: {
                  ...
                  detail::check<exceptions::parse>((expected_result == types::i32 || expected_result == types::i64 ||
                                expected_result == types::f32 || expected_result == types::f64 ||
                                expected_result == types::pseudo), "Invalid type code in if");
               ...
               case opcodes::br_table: {
                  ...
                  detail::check<exceptions::parse>((table_size <= detail::get_max_br_table_elements(_options)), "Too many labels in br_table");
                  ...
                  for (size_t i = 0; i < table_size; i++) {
                     ...
                     if(i == 0) {
                        ...
                        detail::check<exceptions::parse>((result_type == one_result), "br_table labels must have the same type");
                     }
                  }
                  uint32_t label = parse_varuint32(code);
                  auto branch = handler.emit_default(compute_depth_change(label));
                  handle_branch_target(label, branch);
                  detail::check<exceptions::parse>((table_size == 0 || result_type == pc_stack[pc_stack.size() - label - 1].label_result), "br_table labels must have the same type");
                  op_stack.start_unreachable();
               } break;
               case opcodes::call: {
                  check_in_bounds();
               ...
               case opcodes::select: {
                  ...
                  detail::check<exceptions::parse>((t0 == t1 || t0 == any_type || t1 == any_type), "incorrect types for select");
...
#define STORE_OP(op_name, max_align, type)                           \
               case opcodes::op_name: {                              \
                  ...
                  uint32_t offset = parse_varuint32(code);           \
                  detail::check<exceptions::parse>((alignment <= uint32_t(max_align)), "alignment cannot be greater than size."); \
                  detail::check<exceptions::parse>((offset <= detail::get_max_memory_offset(_options)), "store offset too large."); \
...
#undef UNOP
#undef BINOP
               default: detail::fail<exceptions::parse>( "Illegal instruction");
            }
         }
      ...
      void parse_data_segment(wasm_code_ptr& code, data_segment& ds) {
         ...
         auto len =  parse_varuint32(code);
         detail::check<exceptions::parse>((len <= detail::get_max_data_segment_bytes(_options)), "data segment too large.");
         detail::check<exceptions::parse>((static_cast<uint64_t>(static_cast<uint32_t>(ds.offset.value.i32)) + len <= detail::get_max_linear_memory_init(_options)), "out-of-bounds data section");
         auto guard = code.scoped_shrink_bounds(len);
      ...
      inline void parse_section(wasm_code_ptr&                                                                 code,
         ...
         detail::check<exceptions::parse>((elems.size() == _mod->functions.size()), "code section must have the same size as the function section");
...
#undef CHOOSE_FN
    ...
    private:
     ...
     void* emit_branch_target32() {
      ...
      static void unimplemented() { detail::fail<exceptions::parse>( "Sorry, not implemented."); }
      ...
      static native_value call_host_function(Context* context /*rdi*/, native_value* stack /*rsi*/, uint32_t idx /*edx*/) {
         ...
         native_value result;
         ::forge::vm::wasm::longjmp_on_exception([&]() {
      ...
      static void on_unreachable() { ::forge::vm::wasm::throw_<exceptions::interpreter>( "unreachable" ); }
      static void on_fp_error() { ::forge::vm::wasm::throw_<exceptions::interpreter>( "floating point error" ); }
      static void on_call_indirect_error() { ::forge::vm::wasm::throw_<exceptions::interpreter>( "call_indirect out of range" ); }
      static void on_type_error() { ::forge::vm::wasm::throw_<exceptions::interpreter>( "call_indirect incorrect function type" ); }
      static void on_stack_overflow() { ::forge::vm::wasm::throw_<exceptions::interpreter>( "stack overflow" ); }
   };
