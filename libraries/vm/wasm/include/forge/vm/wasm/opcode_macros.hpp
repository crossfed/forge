...
/* clang-format off */
#define FORGE_VM_WASM_CONTROL_FLOW_OPS(opcode_macro)   \
...
#define FORGE_VM_WASM_BR_TABLE_OP(opcode_macro)        \
   opcode_macro(br_table, 0x0E)
#define FORGE_VM_WASM_RETURN_OP(opcode_macro)          \
   opcode_macro(return_, 0x0F)
#define FORGE_VM_WASM_CALL_OPS(opcode_macro)           \
   opcode_macro(call, 0x10)                     \
   opcode_macro(call_indirect, 0x11)            \
   opcode_macro(br_table_data, 0x12)
#define FORGE_VM_WASM_CALL_IMM_OPS(opcode_macro)       \
...
#define FORGE_VM_WASM_PARAMETRIC_OPS(opcode_macro)     \
...
#define FORGE_VM_WASM_VARIABLE_ACCESS_OPS(opcode_macro)\
...
#define FORGE_VM_WASM_MEMORY_OPS(opcode_macro)         \
...
#define FORGE_VM_WASM_I32_CONSTANT_OPS(opcode_macro)   \
   opcode_macro(i32_const, 0x41)
#define FORGE_VM_WASM_I64_CONSTANT_OPS(opcode_macro)   \
   opcode_macro(i64_const, 0x42)
#define FORGE_VM_WASM_F32_CONSTANT_OPS(opcode_macro)   \
   opcode_macro(f32_const, 0x43)
#define FORGE_VM_WASM_F64_CONSTANT_OPS(opcode_macro)   \
   opcode_macro(f64_const, 0x44)
#define FORGE_VM_WASM_COMPARISON_OPS(opcode_macro)     \
...
#define FORGE_VM_WASM_NUMERIC_OPS(opcode_macro)        \
...
#define FORGE_VM_WASM_CONVERSION_OPS(opcode_macro)     \
...
#define FORGE_VM_WASM_EXIT_OP(opcode_macro)            \
   opcode_macro(exit, 0xC0)
#define FORGE_VM_WASM_EMPTY_OPS(opcode_macro)          \
...
#define FORGE_VM_WASM_ERROR_OPS(opcode_macro)          \
   opcode_macro(error, 0xFF)

/* clang-format on */

#define FORGE_VM_WASM_CREATE_ENUM(name, code) name = code,
...
#define FORGE_VM_WASM_OPCODE_NAME_return_

#define FORGE_VM_WASM_OPCODE_NAME_TEST() 1
...
#define FORGE_VM_WASM_IDENTITY(name, code) forge::vm::wasm::FORGE_VM_WASM_OPCODE_T(name),
#define FORGE_VM_WASM_IDENTITY_END(name, code) forge::vm::wasm::FORGE_VM_WASM_OPCODE_T(name)
