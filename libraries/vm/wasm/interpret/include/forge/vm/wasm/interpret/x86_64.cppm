...
export module forge.vm.wasm.interpret.backend:x86_64;
...
#undef CHOOSE_FN
 ...
 private:
...
#ifdef FORGE_VM_WASM_INTERPRET_VALIDATE_JIT_SIZE
   ...
   static native_value call_host_function(Context* context /*rdi*/, native_value* stack /*rsi*/, uint32_t idx /*edx*/) {
      ...
      native_value result;
      ::forge::vm::wasm::interpret::longjmp_on_exception([&]() { result = context->call_host_function(stack, idx); });
      return result;
   }
   ...
   static void on_unreachable() {
      ::forge::vm::wasm::interpret::throw_<exceptions::interpreter>("unreachable");
   }
   static void on_fp_error() {
      ::forge::vm::wasm::interpret::throw_<exceptions::interpreter>("floating point error");
   }
   static void on_call_indirect_error() {
      ::forge::vm::wasm::interpret::throw_<exceptions::interpreter>("call_indirect out of range");
   }
   static void on_type_error() {
      ::forge::vm::wasm::interpret::throw_<exceptions::interpreter>("call_indirect incorrect function type");
   }
   static void on_stack_overflow() {
      ::forge::vm::wasm::interpret::throw_<exceptions::interpreter>("stack overflow");
   }
};
