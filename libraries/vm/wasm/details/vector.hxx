      ...
      class vector {
         public:
            ...
            constexpr inline void pop_back() {
               FORGE_VM_WASM_ASSERT( _index >= 0, exceptions::vector_out_of_bounds, "vector pop out of bounds" );
               _index--;
            }

            constexpr inline T& at( size_t i ) {
               FORGE_VM_WASM_ASSERT( i < _size, exceptions::vector_out_of_bounds, "vector read out of bounds" );
               return _data[i];
            }
