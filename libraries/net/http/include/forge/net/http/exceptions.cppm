...
export module forge.net.http.exceptions;

export import forge.exceptions;

export namespace forge::net::http::exceptions {
...
FORGE_DECLARE_EXCEPTION_CATEGORY(code, "forge.net.http")
...
} // namespace forge::net::http::exceptions
