...
export module forge.net.tcp.exceptions;

export import forge.exceptions;

export namespace forge::net::tcp::exceptions {
...
FORGE_DECLARE_EXCEPTION_CATEGORY(code, "forge.net.tcp")
...
[[nodiscard]] inline std::optional<code> code_of(const forge::exceptions::base& value) noexcept {
   ...
   if (!actual || std::string_view{actual.category().name()} != "forge.net.tcp") {
      return std::nullopt;
   }
...
} // namespace forge::net::tcp::exceptions
