...
class binary_writer {
 public:
   ...
   void endpoint(const forge::net::p2p::endpoint& value) {
      text(value.to_string());
   }

   void optional_endpoint(const std::optional<forge::net::p2p::endpoint>& value) {
   ...
   void p2p_endpoint(const forge::net::p2p::endpoint& value) {
      text(value.to_string());
   }
...
class binary_reader {
 public:
   ...
   [[nodiscard]] forge::net::p2p::endpoint endpoint() {
      return parse_endpoint(text());
   }

   [[nodiscard]] std::optional<forge::net::p2p::endpoint> optional_endpoint() {
      if (!boolean()) {
         return std::nullopt;
      }
      return endpoint();
   ...
   [[nodiscard]] forge::net::p2p::endpoint p2p_endpoint() {
      return parse_endpoint(text());
   }
...
class memory_peer_store_backend final : public peer_store::backend {
 public:
   ...
   void learn_endpoint(peer_id peer, forge::net::p2p::endpoint endpoint, capability_set capabilities) override {
      auto lock = std::scoped_lock{mutex_};
