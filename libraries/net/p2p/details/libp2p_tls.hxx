...
[[nodiscard]] forge::net::stcp::client_options make_libp2p_tls_client_options(const node::options& options);
[[nodiscard]] forge::net::stcp::server_options make_libp2p_tls_server_options(const node::options& options);
