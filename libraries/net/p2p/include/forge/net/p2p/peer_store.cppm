...
class peer_store {
 public:
   ...
   struct rocksdb_options {
      ...
      std::string key_prefix = "forge.net.p2p.peer_store.v1";
   };
...
class peer_store::backend {
 public:
   ...
   virtual void learn_endpoint(peer_id peer, forge::net::p2p::endpoint endpoint, capability_set capabilities) = 0;
   virtual void mark_reachability(peer_id peer, reachability::state state,
                                  std::optional<forge::net::p2p::endpoint> observed) = 0;
   ...
   virtual void mark_endpoint_success(const peer_id& peer, const forge::net::p2p::endpoint& endpoint, path::kind kind,
                                      std::chrono::milliseconds latency) = 0;
   virtual void mark_endpoint_failure(const peer_id& peer, const forge::net::p2p::endpoint& endpoint, path::kind kind,
