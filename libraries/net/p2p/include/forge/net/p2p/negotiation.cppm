...
export module forge.net.p2p.negotiation;
...
namespace protocol_negotiation {
   ...
   boost::asio::awaitable<forge::net::p2p::stream> async_select(forge::net::transport::stream stream, protocol_id protocol,
                                                         options opts = {});
   boost::asio::awaitable<forge::net::p2p::stream> async_select(forge::net::p2p::stream stream, protocol_id protocol,
                                                         options opts = {});
   boost::asio::awaitable<negotiated_stream> async_accept(forge::net::transport::stream stream,
                                                          std::vector<protocol_id> protocols, options opts = {});
   boost::asio::awaitable<negotiated_stream> async_accept(forge::net::p2p::stream stream,
                                                          std::vector<protocol_id> protocols, options opts = {});
} // namespace protocol_negotiation
