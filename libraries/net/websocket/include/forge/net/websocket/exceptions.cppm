...
export module forge.net.websocket.exceptions;

export import forge.exceptions;

export namespace forge::net::websocket::exceptions {
...
FORGE_DECLARE_EXCEPTION_CATEGORY(code, "forge.net.websocket")
...
} // namespace forge::net::websocket::exceptions
