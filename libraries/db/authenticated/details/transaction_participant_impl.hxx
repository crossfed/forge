...
class transaction_participant_impl final
    : public forge::db::core::transaction_participant {
 public:
   ...
   prepare_savepoint(forge::db::core::savepoint_id_t id) override;
   ...
   release_savepoint(forge::db::core::savepoint_id_t id,
                     forge::db::core::participant_access& access) override;
   boost::asio::awaitable<void>
   prepare_commit(forge::db::core::participant_access& access) override;
