...
export module forge.crypto.digest.hmac;
...
typedef hmac<forge::crypto::digest::sha224> hmac_sha224;
typedef hmac<forge::crypto::digest::sha256> hmac_sha256;
typedef hmac<forge::crypto::digest::sha512> hmac_sha512;
