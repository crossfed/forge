...
#define FORGE_HTTP_GET(NAME, TARGET, ...)                                                                             \
   (NAME, (::forge::api::http::route_builder{::forge::net::http::method::get, BOOST_PP_STRINGIZE(NAME), TARGET,               \
                                          ::forge::net::http::status::ok} FORGE_HTTP_DETAIL_OPTIONS(__VA_ARGS__))             \
             .build())
#define FORGE_HTTP_HEAD(NAME, TARGET, ...)                                                                            \
   (NAME, (::forge::api::http::route_builder{::forge::net::http::method::head, BOOST_PP_STRINGIZE(NAME), TARGET,              \
                                          ::forge::net::http::status::ok} FORGE_HTTP_DETAIL_OPTIONS(__VA_ARGS__))             \
             .build())
#define FORGE_HTTP_POST(NAME, TARGET, STATUS, ...)                                                                    \
   (NAME, (::forge::api::http::route_builder{::forge::net::http::method::post, BOOST_PP_STRINGIZE(NAME), TARGET,              \
                                          ::forge::net::http::status::STATUS} FORGE_HTTP_DETAIL_OPTIONS(__VA_ARGS__))         \
             .build())
#define FORGE_HTTP_PUT(NAME, TARGET, STATUS, ...)                                                                     \
   (NAME, (::forge::api::http::route_builder{::forge::net::http::method::put, BOOST_PP_STRINGIZE(NAME), TARGET,               \
                                          ::forge::net::http::status::STATUS} FORGE_HTTP_DETAIL_OPTIONS(__VA_ARGS__))         \
             .build())
#define FORGE_HTTP_PATCH(NAME, TARGET, STATUS, ...)                                                                   \
   (NAME, (::forge::api::http::route_builder{::forge::net::http::method::patch, BOOST_PP_STRINGIZE(NAME), TARGET,             \
                                          ::forge::net::http::status::STATUS} FORGE_HTTP_DETAIL_OPTIONS(__VA_ARGS__))         \
             .build())
#define FORGE_HTTP_DELETE(NAME, TARGET, STATUS, ...)                                                                  \
   (NAME, (::forge::api::http::route_builder{::forge::net::http::method::delete_, BOOST_PP_STRINGIZE(NAME), TARGET,           \
                                          ::forge::net::http::status::STATUS} FORGE_HTTP_DETAIL_OPTIONS(__VA_ARGS__))         \
             .build())
...
#define FORGE_HTTP_DETAIL_ROUTE_CALL(r, INTERFACE, ROUTE)                                                             \
   ::forge::api::http::detail::make_route_call<&INTERFACE::FORGE_HTTP_DETAIL_METHOD(ROUTE),                                  \
                                        ::forge::api::core::method_request_t<&INTERFACE::FORGE_HTTP_DETAIL_METHOD(ROUTE)>,     \
                                        ::forge::api::core::method_response_t<&INTERFACE::FORGE_HTTP_DETAIL_METHOD(ROUTE)>>(   \
      FORGE_HTTP_DETAIL_ROUTE(ROUTE)),
   ...
   FORGE_HTTP_DETAIL_METHOD(ROUTE)(                                                                                   \
      ...
      if constexpr (::forge::api::core::method_argument_count_v<&INTERFACE::FORGE_HTTP_DETAIL_METHOD(ROUTE)> == 1U) {         \
         ...
         if constexpr (::forge::api::http::detail::is_positional_http_method_v<                                            \
            ...
            co_return co_await ::forge::api::http::detail::call_arguments<decltype(arguments),                             \
               ::forge::api::core::method_response_t<&INTERFACE::FORGE_HTTP_DETAIL_METHOD(ROUTE)>>(                           \
   ...
   template <> struct traits<INTERFACE> {                                                                  \
      ...
      static std::shared_ptr<::forge::api::core::remote_invoker> make_invoker(::forge::net::http::client& value) {                              \
         return ::forge::api::http::detail::make_route_invoker(                                                            \
            ...
            std::vector<::forge::api::http::detail::route_call>{                                                           \
   ...
   template <> class proxy<INTERFACE> : public ::forge::api::core::proxy<INTERFACE> {                                      \
    public:                                                                                                         \
      explicit proxy(::forge::net::http::client& value)                                                                    \
          : ::forge::api::core::proxy<INTERFACE>(traits<INTERFACE>::make_invoker(value), INTERFACE::ref()), client_(&value) {} \
