...
| [chain/core](libraries/chain/README.md) | `forge_chain_core` | Fundamental chain digest and Merkle primitives. | `forge_crypto`, `forge_exceptions`, `forge_raw`. |
| [chain/protocol](libraries/chain/README.md) | `forge_chain_protocol` | Canonical protocol values, transactions, blocks, ABI and signing rules. | `forge_chain_core`, `forge_compression`, `forge_raw`, `forge_variant`, `forge_crypto`. |
