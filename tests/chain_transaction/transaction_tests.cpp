...
BOOST_AUTO_TEST_CASE(builder_matches_spring_transaction_golden) {
   ...
   // Generated by Spring's fc::raw::pack(transaction); see SPRING_GOLDEN.md.
   constexpr auto spring_expected = "010000000100ddccbbaa00000000010000000000ea305500000000b863b2c20002010200";
   BOOST_TEST(forge::codec::hex::encode(forge::raw::pack(value.value)) == spring_expected);
