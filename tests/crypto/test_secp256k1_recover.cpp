...
using recover_bytes = forge::crypto::asymmetric::secp256k1::recover_bytes;
...
BOOST_AUTO_TEST_CASE(recover) try {
   ...
   for (const auto& test : tests) {
      ...
      auto res = forge::crypto::asymmetric::secp256k1::recover(signature, digest);
...
BOOST_AUTO_TEST_CASE(recover_rejects_invalid_signature) try {
   const auto call_with_bad_recovery_id = [] {
      (void)forge::crypto::asymmetric::secp256k1::recover(
          to_bytes("01174de755b55bd29026d626f7313a5560353dc5175f29c78d79d961b81a0c04360d833ca789bc16d4ee714a6d1a19461d8"
                   "90966e0ec5c"
                   "074f67be67e631d33aa7"),
          to_bytes("45fd65f6dd062fe7020f11d19fe5c35dc4d425e1479c0968c8e932c208f25399"));
   };

   BOOST_CHECK_EXCEPTION(call_with_bad_recovery_id(), forge::crypto::asymmetric::secp256k1::exceptions::invalid_signature,
                         [](const forge::crypto::asymmetric::secp256k1::exceptions::invalid_signature& error) {
                            return error.code().category().name() == std::string_view{"forge.crypto.asymmetric.secp256k1"};
                         });
}
FORGE_LOG_AND_RETHROW();
...
BOOST_AUTO_TEST_CASE(recover_rejects_invalid_input_sizes) try {
   const auto call_with_short_signature = [] {
      (void)forge::crypto::asymmetric::secp256k1::recover(
          to_bytes("174de755b55bd29026d626f7313a5560353dc5175f29c78d79d961b81a0c04360d833ca789bc16d4ee714a6d1a19461d890"
                   "966e0ec5c07"
                   "4f67be67e631d33aa7"),
          to_bytes("45fd65f6dd062fe7020f11d19fe5c35dc4d425e1479c0968c8e932c208f25399"));
   };
   BOOST_CHECK_EXCEPTION(call_with_short_signature(), forge::crypto::asymmetric::secp256k1::exceptions::invalid_input,
                         [](const forge::crypto::asymmetric::secp256k1::exceptions::invalid_input& error) {
                            return error.code().category().name() == std::string_view{"forge.crypto.asymmetric.secp256k1"};
                         });

   const auto call_with_short_digest = [] {
      (void)forge::crypto::asymmetric::secp256k1::recover(
          to_bytes("00174de755b55bd29026d626f7313a5560353dc5175f29c78d79d961b81a0c04360d833ca789bc16d4ee714a6d1a19461d8"
                   "90966e0ec5c"
                   "074f67be67e631d33aa7"),
          to_bytes("fd65f6dd062fe7020f11d19fe5c35dc4d425e1479c0968c8e932c208f25399"));
   };
   BOOST_CHECK_EXCEPTION(call_with_short_digest(), forge::crypto::asymmetric::secp256k1::exceptions::invalid_input,
                         [](const forge::crypto::asymmetric::secp256k1::exceptions::invalid_input& error) {
                            return error.code().category().name() == std::string_view{"forge.crypto.asymmetric.secp256k1"};
                         });
}
