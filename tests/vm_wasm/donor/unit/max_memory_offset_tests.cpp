...
#define FORGE_VM_WASM_INTERPRET_TEST_FILE max_memory_offset_tests
...
BACKEND_TEST_CASE("Test max_memory_offset static fail", "[max_memory_offset_test]") {
   ...
   BOOST_CHECK_THROW(backend_t(max_load_offset_wasm, &wa), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(max_store_offset_wasm, &wa), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(load_offset_2_wasm, &wa), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(store_offset_2_wasm, &wa), exceptions::parse);
}
...
BACKEND_TEST_CASE("Test max_memory_offset dynamic fail", "[max_memory_offset_test]") {
   ...
   BOOST_CHECK_THROW(backend_t(max_load_offset_wasm, nullptr, dynamic_options{1}), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(max_store_offset_wasm, nullptr, dynamic_options{1}), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(load_offset_2_wasm, nullptr, dynamic_options{1}), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(store_offset_2_wasm, nullptr, dynamic_options{1}), exceptions::parse);
}

BACKEND_TEST_CASE("Test max_memory_offset dynamic pass", "[max_memory_offset_test]") {
   using backend_t = backend<std::nullptr_t, TestType, dynamic_options>;
   BOOST_CHECK_THROW(backend_t(max_load_offset_wasm, nullptr, dynamic_options{2}), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(max_store_offset_wasm, nullptr, dynamic_options{2}), exceptions::parse);
