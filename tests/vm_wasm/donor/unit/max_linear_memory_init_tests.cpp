...
#define FORGE_VM_WASM_INTERPRET_TEST_FILE max_linear_memory_init_tests
...
BACKEND_TEST_CASE("Test max_linear_memory_init default", "[max_linear_memory_init_test]") {
   ...
   BOOST_CHECK_THROW(backend_t(wrap_data_wasm, &wa), exceptions::memory);
}
...
BACKEND_TEST_CASE("Test max_linear_memory_init static", "[max_linear_memory_init_test]") {
   ...
   backend_t backendfull12(full_12_data_wasm, &wa);
   backend_t backendempty12(empty_12_data_wasm, &wa);
   BOOST_CHECK_THROW(backend_t(empty_13_data_wasm, &wa), exceptions::parse);
   backend_t backendone11(one_11_data_wasm, &wa);
   BOOST_CHECK_THROW(backend_t(one_12_data_wasm, &wa), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(wrap_data_wasm, &wa), exceptions::parse);
}
...
BACKEND_TEST_CASE("Test max_linear_memory_init dynamic", "[max_linear_memory_init_test]") {
   ...
   BOOST_CHECK_THROW(backend_t(empty_13_data_wasm, nullptr, dynamic_options{12}), exceptions::parse);
   backend_t backendone11(one_11_data_wasm, nullptr, dynamic_options{12});
   BOOST_CHECK_THROW(backend_t(one_12_data_wasm, nullptr, dynamic_options{12}), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(wrap_data_wasm, nullptr, dynamic_options{12}), exceptions::parse);
}
