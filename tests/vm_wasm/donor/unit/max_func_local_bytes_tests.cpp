...
#define FORGE_VM_WASM_INTERPRET_TEST_FILE max_func_local_bytes_tests
...
BACKEND_TEST_CASE("Test max_func_local_bytes static fail", "[max_func_local_bytes_test]") {
   {
      ...
      backend_t backend_unused(unused_type_wasm, &wa);
      BOOST_CHECK_THROW(backend_t(param_16_wasm, &wa), exceptions::parse);
      BOOST_CHECK_THROW(backend_t(local_16_wasm, &wa), exceptions::parse);
      backend_t backend_stack(stack_16_wasm, &wa);
      BOOST_CHECK_THROW(backend_t(mixed_16_wasm, &wa), exceptions::parse);
   }
   {
      using backend_t = backend<std::nullptr_t, TestType, static_options<8, ls>>;
      backend_t backend_param(param_16_wasm, &wa);
      BOOST_CHECK_THROW(backend_t(local_16_wasm, &wa), exceptions::parse);
      BOOST_CHECK_THROW(backend_t(stack_16_wasm, &wa), exceptions::parse);
   }
   {
...
BACKEND_TEST_CASE("Test max_func_local_bytes dynamic fail", "[max_func_local_bytes_test]") {
   ...
   BOOST_CHECK_THROW(backend_t(param_16_wasm, nullptr, dynamic_options{8, lp}), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(param_16_wasm, nullptr, dynamic_options{8, ps}), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(local_16_wasm, nullptr, dynamic_options{8, lp}), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(local_16_wasm, nullptr, dynamic_options{8, ls}), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(stack_16_wasm, nullptr, dynamic_options{8, ls}), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(stack_16_wasm, nullptr, dynamic_options{8, ps}), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(mixed_16_wasm, nullptr, dynamic_options{8, lp}), exceptions::parse);
   }

   {
   using backend_t = backend<std::nullptr_t, TestType, dynamic_options_empty_flags>;
   BOOST_CHECK_THROW(backend_t(local_16_wasm, nullptr, dynamic_options_empty_flags{8}), exceptions::parse);
   BOOST_CHECK_THROW(backend_t(stack_16_wasm, nullptr, dynamic_options_empty_flags{8}), exceptions::parse);
   }
}
