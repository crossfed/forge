...
*/
   ...
   BOOST_TEST(static_cast<bool>(check == 0));
   bkend("env", "call_test_f");
   BOOST_TEST(static_cast<bool>(check == 77));
   ...
   BOOST_TEST(static_cast<bool>(check2 == 1));
   bkend("env", "call_test_h");
   BOOST_TEST(static_cast<bool>(check2 == 2));

   check2 = 0;
   bkend("env", "call_test_j");
   BOOST_TEST(static_cast<bool>(check2 == 4));
   bkend("env", "call_test_j");
   BOOST_TEST(static_cast<bool>(check2 == 8));
}
